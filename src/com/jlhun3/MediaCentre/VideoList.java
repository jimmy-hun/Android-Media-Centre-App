...
public class VideoList extends ListActivity {
    private static final String MEDIA_PATH = new String("/sdcard/Media/Video/");  // path to music folder
    public ArrayAdapter<String> songList;  // holds songs

    private static final String[] extensions = {".mp4"};  // extensions for checking files
    ...
    // this is where the Video class is called via a intent and a parsed value (playThisFile) will determine the directory
    public void playSong(String playThisFile) {
        Intent intent = new Intent(getApplication(), Video.class);  // open a new music instance
